// File:        hashtable.h
// Date:        March 25, 2016
// Description: Definition of a hash table class 
...
class HashTable
{
  ...
  public:
	...
	void HashTable::HashPrint()
	{
		...
		{
			cout << i << ":\t"; table[i].Print();
		}
		cout << "Items: " << this->size << endl;
		cout << "Max Size: " << this->maxsize << endl;
		cout << "Load Factor: " << setprecision(2) << fixed << this->LoadFactor()*100 << "%" << endl << endl;
	}
