...
#set target_library scripts/spicelib_180_ss_105_125C_X1X4.db
#set target_library scripts/spicelib_180_ss_105_125C_X1.db
#set target_library scripts/spicelib_180_ss_105_125C_X4.db

#set target_library scripts/spicelib_180_ss_105_125C_layout.db
#set target_library scripts/spicelib_180_ss_105_125C_layout_x1_x4.db
...
analyze -format vhdl ../vhdl/sqrt_conv.vhd
...
create_clock -name CLK -period 1000 -waveform {0 500} {clk}
