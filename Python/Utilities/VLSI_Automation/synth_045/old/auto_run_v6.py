...
def folder_selection():
    ...
    for item in result_folders_list:
        if (sys.argv[1] == "-g" or sys.argv[1] == "-x") and os.path.isdir(os.getcwd() + os.sep + item) and "auto_result" in item and "_extracted" not in item:
...
if __name__ == "__main__":
    ...
    # TODO: Add more run info/error info/error checking
    ...
    # TODO: Show result information at end of script
    ...
    try:
        if "-g" == sys.argv[1] or "-x" == sys.argv[1] or "-z" == sys.argv[1]:
